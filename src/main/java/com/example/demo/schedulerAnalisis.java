...
//                List<Map<String, Object>> influyentes= neo.getUsuariosInfluyentes(equipo.getName());
                ...
                double influencia ;
                    if(Double.parseDouble(tweet.getFollowers())>=10504.222222222223){

                        float[] datos=neo.getInfluencia(tweet.getName(),equipo.getName());
                        if(datos!=null){
                            influencia= 1.0+((datos[0]/3335299.440625)*0.7+(datos[1]/15)*0.3);
                        }
